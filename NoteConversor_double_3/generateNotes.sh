...
./wav_parser_op3.elf -F ../SameSize-1.06MB/F#4v8-2.wav -O Twinkle_Twinkle_Little_Star/G4_ -T G4 -B F#4

./wav_parser_op3.elf -F ../SameSize-1.06MB/D#4v8-2.wav -O Twinkle_Twinkle_Little_Star/F4_ -T F4 -B D#4

./wav_parser_op3.elf -F ../SameSize-1.06MB/D#4v8-2.wav -O Twinkle_Twinkle_Little_Star/E4_ -T E4 -B D#4

./wav_parser_op3.elf -F ../SameSize-1.06MB/C4v8-2.wav -O Twinkle_Twinkle_Little_Star/D4_ -T D4 -B C4
